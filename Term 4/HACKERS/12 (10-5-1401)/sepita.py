...
class Thermometer:
    def __init__(self, root, color1='red', color2='Light gray', dama=25):
        self.root = root
        self.dama = dama
    ...
    def grid(self, row=1, column=1):
        self.temp.place(x=40,y=self.dama,height=self.dama,width=10) 
        self.spin.place(x=10,y=110,height=20,width=75)
        self.frame.place(x=5,y=0,width=100,height=155)

root=Tk()
root.geometry()
dama1 = Thermometer(root,'red','pink',25)
dama2 = Thermometer(root,'gold','pink',60)
